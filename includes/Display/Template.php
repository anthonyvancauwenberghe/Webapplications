                ...
                <div class="x_content">
                  <div class="widget_summary">
                    <div class="w_left w_25">
                      <span><h5>NPC Name</h5></b></span>
                    </div>

                    <div class="w_right w_20">
                      <span><h5>Kills</h5></b></span>
                    </div>
                    <div class="clearfix"></div>
                  </div>
                      ...
                      <li>
                        <div class="block">
                          <div class="block_content">
                            <h2 class="title">
                                              <a>Achievement 100 PVP Kills Completed!</a>
                                          </h2>
                            <div class="byline">
                              <span>13 hours ago</span> 
                            </div>
                            <p class="excerpt">You recently completed the 100 PvP kills achievement next up 250!/a>
                            </p>
                          </div>
                        </div>
                      </li>
